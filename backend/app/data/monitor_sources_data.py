...
PROVINCIAL_SOURCES = [
    ...
    },
    {
        ...
        "columns": [
            ...
            {"column_name": "政策文件", "column_url": "https://jyt.nmg.gov.cn/zcfg_25133/", "column_type": ColumnType.POLICY, "crawl_interval": 60},
        ],
    },
    {
        "name": "辽宁省教育厅",
    ...
    {
        "name": "四川省教育厅",
        "url": "https://jyt.sc.gov.cn",
        "type": SourceType.PROVINCIAL,
        "columns": [
            {"column_name": "通知公告", "column_url": "https://jyt.sc.gov.cn/zwgk/tzgg/", "column_type": ColumnType.NOTICE, "crawl_interval": 30},
            {"column_name": "政策文件", "column_url": "https://jyt.sc.gov.cn/zwgk/zcfg/", "column_type": ColumnType.POLICY, "crawl_interval": 60},
        ],
    },
    {
        "name": "贵州省教育厅",
        ...
        "columns": [
            ...
            {"column_name": "政策文件", "column_url": "https://jyt.guizhou.gov.cn/zwgk/zcwj/", "column_type": ColumnType.POLICY, "crawl_interval": 60},
        ],
    },
    {
        "name": "云南省教育厅",
